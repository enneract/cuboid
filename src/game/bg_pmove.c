...
float pm_airControlAmount = 150.0f; //Equivalence to side strafes value is approx ~165

//Side Air Strafes
float	cpm_pm_strafeaccelerate = 70; //GoldSRC used 150. vq3: 1
...
static void PM_Weapon( void )
{
  ...
  if( attack3 )
  {
    if( BG_Weapon( pm->ps->weapon )->hasThirdMode )
    {
      ...
      if( ( pm->ps->weapon == WP_ALEVEL3_UPG || 
