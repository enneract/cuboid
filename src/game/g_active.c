...
Send spawn queue data to a client (used to be in SpectatorThink)
=================
*/
void G_ClientUpdateSpawnQueue( gclient_t *client )
{
  if( client->ps.stats[ STAT_TEAM ] == TEAM_ALIENS )
  {
    ...
    client->ps.persistant[ PERS_SPAWNS_IMPLANTED ] = level.numAlienImplantedSpawns;
  }
  else if( client->ps.stats[ STAT_TEAM ] == TEAM_HUMANS )
  {
    ...
    client->ps.persistant[ PERS_SPAWNS_IMPLANTED ] = level.numHumanImplantedSpawns;
  }
}
